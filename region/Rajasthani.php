...
<html>
		...
		.links a{
		 ...
		 .container{
		  width:90%;
			...
			margin-bottom:10%;
			height:auto;
			overflow:hidden;/*solved the problem of scrollbars*/
			background:white;
			border-radius:5%;
    ...
    history.pushState(null, null, '<?php echo "../".$region_addr;?>');
	...
	<div class="container">
	  <div class="article_container">
	       <h2><?php echo strtoupper($region_name);?></h2>
		...
		<ul>
		    <?php
		      while($row=$res_links->fetch_assoc()){
				  print "<li><a href=\""."../redirect_to_region.php?link=".$row['region_addr']."\">".$row['region_name']."</a></li>";
			  }
		   ?>
		</ul>
		  <div class="comments">
